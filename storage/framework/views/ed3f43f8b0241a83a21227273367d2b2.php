    ...
    <nav class="fixed w-full z-50 bg-[#09090b]/80 backdrop-blur-md border-b border-white/10">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden md:flex items-center space-x-8 text-sm font-medium text-gray-400">
                ...
                <a href="<?php echo e(route('tv.index')); ?>" class="hover:text-white transition-colors">TV Shows</a>
                <a href="<?php echo e(route('books.index')); ?>" class="hover:text-white transition-colors">Books</a>
                <!-- Yahan humne Music ka link active kar diya hai -->
                <a href="<?php echo e(route('music.index')); ?>" class="hover:text-white transition-colors">Music</a>
                
                <form action="<?php echo e(route('movie.search')); ?>" method="GET" class="relative group ml-4">
            ...
            <div class="flex items-center space-x-4">
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <a href="<?php echo e(route('dashboard')); ?>" class="text-sm font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 hover:opacity-80 transition-opacity">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-400 hover:text-white">Log in</a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-black px-5 py-2 rounded-full text-sm font-semibold hover:scale-105 transition-transform duration-200">Sign Up</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
...
</html><?php /**PATH C:\Users\DELL\Herd\le8sea\resources\views/components/layout.blade.php ENDPATH**/ ?>