...
<?php $component->withAttributes([]); ?>
    <div class="relative w-full h-[60vh] bg-gray-900">
        <?php if(isset($show['backdrop_path'])): ?>
            <img src="https://image.tmdb.org/t/p/original<?php echo e($show['backdrop_path']); ?>" alt="<?php echo e($show['name']); ?>" class="w-full h-full object-cover opacity-40">
        <?php endif; ?>
    ...
    <main class="max-w-7xl mx-auto px-6 -mt-32 relative z-10 pb-20">
        <div class="flex flex-col md:flex-row gap-10">
            ...
            <div class="w-full md:w-1/3 lg:w-1/4 flex-shrink-0">
                <?php if(isset($show['poster_path'])): ?>
                    <img src="https://image.tmdb.org/t/p/w500<?php echo e($show['poster_path']); ?>" alt="<?php echo e($show['name']); ?>" class="w-full rounded-2xl shadow-2xl border border-white/10 hover:scale-105 transition-transform duration-300">
                <?php else: ?>
            ...
            <div class="w-full md:w-2/3 lg:w-3/4 pt-4 md:pt-12">
                <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight mb-2">
                    ...
                    <span class="text-2xl md:text-4xl text-gray-500 font-normal">
                        (<?php echo e(isset($show['first_air_date']) ? \Carbon\Carbon::parse($show['first_air_date'])->format('Y') : 'N/A'); ?>)
                    </span>
                </h1>

                <?php if(isset($show['tagline']) && $show['tagline']): ?>
                    <p class="text-xl text-cyan-400 italic mb-6">"<?php echo e($show['tagline']); ?>"</p>
                <?php endif; ?>
                ...
                <div class="flex items-center gap-6 mb-8 text-sm md:text-base">
                    <div class="flex items-center gap-2 bg-yellow-500/10 text-yellow-400 px-4 py-2 rounded-full border border-yellow-500/20 font-bold">
                        <span>★</span> <?php echo e(number_format($show['vote_average'], 1)); ?> / 10
                    </div>
                    <div class="text-gray-400 font-medium">
                        <?php echo e($show['number_of_seasons']); ?> Seasons • <?php echo e($show['number_of_episodes']); ?> Episodes
                    </div>
                ...
                <?php if(isset($show['created_by']) && count($show['created_by']) > 0): ?>
                <div class="mb-10">
                    <h3 class="text-xl font-bold mb-2">Created By</h3>
                    <div class="flex gap-4 flex-wrap">
                        <?php $__currentLoopData = $show['created_by']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $creator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="bg-white/10 px-4 py-2 rounded-lg text-gray-300"><?php echo e($creator['name']); ?></span>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="mt-20 border-t border-white/10 pt-16 flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-2/3">
                ...
                <?php if(auth()->guard()->check()): ?>
                    ...
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="media_id" value="<?php echo e($show['id']); ?>">
...
<?php endif; ?><?php /**PATH C:\Users\DELL\Herd\le8sea\resources\views/tv-details.blade.php ENDPATH**/ ?>