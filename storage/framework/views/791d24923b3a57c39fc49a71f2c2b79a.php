    ...
    <main class="pb-16 px-6 pt-32 max-w-7xl mx-auto">
        ...
        <div class="bg-[#18181b] rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
            ...
            <div class="text-center md:text-left relative z-10 flex-grow">
                <h1 class="text-3xl md:text-5xl font-bold mb-2"><?php echo e($user->name); ?></h1>
                <p class="text-gray-400 text-lg mb-6"><?php echo e($user->email); ?></p>
                
                <div class="flex flex-wrap gap-3 justify-center md:justify-start">
                    <a href="<?php echo e(route('profile.edit')); ?>" class="bg-white/10 hover:bg-white/20 text-white px-5 py-2.5 rounded-full text-sm font-semibold transition-colors flex items-center gap-2 border border-white/5">
                    ...
                    <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="bg-[#18181b] p-6 rounded-2xl border border-white/5 hover:border-white/20 hover:-translate-y-1 transition-all flex flex-col h-full group">
                            <div class="flex justify-between items-start mb-4">
                                <span class="text-xs font-bold uppercase tracking-widest px-2.5 py-1 rounded-md border <?php echo e($badgeColor); ?>">
                                    <?php echo e($review->media_type); ?>

                                </span>
                                <span class="text-xs text-gray-500 font-medium"><?php echo e($review->created_at->diffForHumans()); ?></span>
                            </div>
                            ...
                            <a href="<?php echo e($route); ?>" class="text-sm font-bold text-white group-hover:text-cyan-400 transition-colors inline-flex items-center gap-1.5 mt-auto">
                                View Content 
...
<?php endif; ?><?php /**PATH C:\Users\DELL\Herd\le8sea\resources\views/dashboard.blade.php ENDPATH**/ ?>